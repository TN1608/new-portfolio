...
export function ScrollProgress() {
    ...
    return (
        <div
            ref={containerRef}
            className={`fixed right-6 top-1/2 -translate-y-1/2 z-50 flex flex-col items-end gap-1 mix-blend-difference transition-all duration-500 ${isHidden ? "opacity-0 pointer-events-none translate-x-4" : "opacity-100 translate-x-0"
                }`}
        >
            {/* Percent */}
